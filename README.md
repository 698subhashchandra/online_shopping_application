...
[![License](https://img.shields.io/badge/License-MIT-green.svg)](../online_shopping_application/LICENSE)
...
1. Home Page
![Home Page](../online_shopping_application/public/homePage.png)
1. Admin Page
![Admin Page](../online_shopping_application/public/adminPage.png)

## Guidelines & Resources

Before diving into the tasks, please review the following key resources:

- [CONTRIBUTING.md](../online_shopping_application/CONTRIBUTING.md): Guidelines for code contributions, commit messages, and overall coding standards.
...
- Understood the [ROADMAP.md](ROADMAP.md) and [CONTRIBUTING.md](../online_shopping_application/CONTRIBUTING.md) for build up the project.
- Gathering the resources needed to fulfill the [`Task`](#task).
- Build a [`Docker Installation Script`](../online_shopping_application/docker_installation.sh) automation script for installing and using Docker.
...
- Build a [`.dockerignore`](../online_shopping_application/.dockerignore) file for ignoring the `Files and Directory` which are unecessary.
...
- Implemented `Docker Scout` for Checking `Vulnerabilties` of Application. [`Docker Scout Report`](../online_shopping_application/image_report.md)
